  ...
  const startCamera = async () => {
    try {
      ...
      if (result.granted) {
        ...
        Alert.alert("Caméra requise", `Le selfie doit être pris en direct avec la caméra frontale. ${hint}`);
      }
    } catch {
      Alert.alert("Autorisation indisponible", "La demande d’accès à la caméra a échoué. Vérifiez l’autorisation caméra de Business Ivoire puis réessayez.");
    } finally {
